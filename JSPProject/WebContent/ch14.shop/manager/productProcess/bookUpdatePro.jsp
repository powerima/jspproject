...
<%
	...
	String book_preimage = imageUp.getParameter("book_preimage");
	...
	// 이전 파일 삭제이 존재하고 새로 업로될 파일이 존재하면 이전 파일 삭제
	if(filename != null && book_preimage != null){
		File f = new File(realFolder + book_preimage);
		f.delete();
	} 
	else if(book_preimage != null){
		filename = book_preimage;
	}
